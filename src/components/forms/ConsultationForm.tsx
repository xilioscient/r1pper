        ...
        {isOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="mb-6">
                <h2 className="text-3xl font-bold text-cyber-neon tracking-tighter uppercase italic">
                  ...
                  <div className="flex space-x-6">
                    {["high", "normal", "low"].map((p) => (
                      ...
                      >
                        ...
                        />
                        <span className="ml-2 text-cyber-neon text-sm uppercase">
                          {p === "high"
                            ? "Alta"
                            : p === "normal"
                              ? "Normale"
                  ...
                  <AnimatePresence>
                    {submitStatus === "success" && (
                      <motion.p
                        ...
                        className="text-cyber-acid text-center font-mono text-sm mt-4 uppercase"
                      >
                    ...
                    {submitStatus === "error" && (
                      <motion.p
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="text-red-500 text-center font-mono text-sm mt-4 uppercase"
                      >
