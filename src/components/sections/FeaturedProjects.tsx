...
const projects = [
  {
    ...
    description:
      "Toolkit avanzato per l’analisi del protocollo 802.11 e il penetration testing, con capacità di iniezione pacchetti in tempo reale e rilevamento degli attacchi di deautenticazione",
  ...
  },
  {
    title: "AirBreaker",
    description:
      "Strumento completo per la valutazione della sicurezza delle reti wireless, con moduli avanzati di exploit e scansione automatizzata delle vulnerabilità",
  ...
  },
  {
    ...
    description:
      "Processore da linea di comando per file Excel ad alte prestazioni, con funzionalità avanzate di manipolazione dei dati e automazione",
  ...
  },
  {
    ...
    description:
      "Piattaforma automatizzata per la valutazione della sicurezza, con funzionalità complete di scansione delle vulnerabilità e reportistica",
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle title="Featured Projects" subtitle="Ricerca & Sviluppo" />
                    ...
                    <div className="relative w-full h-full rounded-xl overflow-hidden cyber-card group">
                      ...
                      <div className="absolute inset-0 flex flex-col justify-end p-8">
                        ...
                        <span
                          ...
                          ${
                            project.category === "Red Team"
                              ? "bg-cyber-blood/20 text-cyber-blood border border-cyber-blood/50"
                              : project.category === "Tools"
                                ? "bg-cyber-dream/20 text-cyber-dream border border-cyber-dream/50"
