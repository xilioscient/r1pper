...
export default function OpenAICarousel() {
    ...
    if (loading) {
        return <div className="text-center p-10 neon-text">Caricamento News...</div>;
    }
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-12">
                    ...
                    <div
                        ...
                        style={{ background: `linear-gradient(to right, rgb(var(--color-cyber-neon)), transparent)` }}
                    />
                </div>
                    ...
                    <div className="flex space-x-8 overflow-x-auto pb-12 pt-4 scrollbar-hide snap-x snap-mandatory pointer-events-auto">
                        {news.length > 0 ? (
                            news.map((item, index) => (
                                ...
                                >
                                    ...
                                    <div className="relative h-full bg-gray-950 border border-white/5 p-8 rounded-xl overflow-hidden shadow-2xl">
                                        ...
                                        >
                                            {new Date(item.pubDate).toLocaleDateString('it-IT', { day: '2-digit', month: 'short', year: 'numeric' })}
                                        </span>
                                        ...
                                        <div className="flex items-center justify-between mt-auto">
                                            ...
                                            >
                                                <span className="relative z-10 group-hover/btn:text-cyber-neon transition-colors">Access Terminal</span>
                                                <span
                            ...
                            <div className="w-full h-64 flex items-center justify-center border border-dashed border-white/10 rounded-xl">
                                <p className="font-mono animate-pulse opacity-50 text-white">SYSTEM_IDLE: NO_DATA</p>
                            </div>
                        )}
                    </div>
                </div>
