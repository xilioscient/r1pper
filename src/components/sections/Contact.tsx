...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="py-16 bg-cyber-void relative overflow-hidden"
    >
      <div className="absolute inset-0 cyber-grid opacity-10" />

      <div className="container mx-auto px-4 relative">
        <SectionTitle title="Contatti" subtitle="Parliamo del tuo progetto" />
            ...
            <div className="bg-gradient-to-r from-cyber-neon to-cyber-acid p-[2px] rounded-lg">
              <div className="bg-cyber-void p-6 rounded-lg">
                ...
                <p className="text-cyber-neon/80">
                  Sono disponibile per consulenze e progetti dal lunedì al
                  venerdì. Per emergenze o progetti critici, sono reperibile
                  anche nel weekend.
                </p>
              </div>
            </div>
