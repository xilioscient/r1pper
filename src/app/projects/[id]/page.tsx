  ...
  if (!project) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-cyber-black">
        ...
        <Link
          href="/projects"
          className="text-cyber-magenta hover:underline font-mono"
        >
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {project.details.features.map((feature, i) => (
                  <div
                    key={i}
                    className="flex gap-3 p-4 bg-white/5 border border-white/5 hover:border-cyber-magenta/30 transition-colors"
                  >
            ...
            <div className="p-6 border border-white/10 bg-white/5">
              ...
              <div className="flex flex-wrap gap-2">
                {project.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-cyber-cyan/10 text-cyber-cyan text-xs border border-cyber-cyan/20"
                  >
                    {tag}
                  </span>
                ))}
