...
export const projects: Project[] = [
  {
    ...
    description:
      "Toolkit avanzato per l'analisi del protocollo 802.11 e il penetration testing, con capacità di iniezione pacchetti in tempo reale e rilevamento di attacchi di deautenticazione",
  ...
  },
  {
    ...
    description:
      "Processore da linea di comando per file Excel ad alte prestazioni, con funzionalità avanzate di manipolazione dati e automazione",
