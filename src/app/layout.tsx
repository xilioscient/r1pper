...
export const metadata: Metadata = {
  ...
  description: 'Esplorando i confini del digitale. Ricerca, analisi e comprensione dei sistemi. Un viaggio oltre la superficie del codice.',
  keywords: ['sicurezza', 'privacy', 'ricerca', 'analisi', 'sistemi', 'codice', 'digitale', 'cyberspazio'],
  authors: [{ name: 'Alessandro Faraone' }],
  openGraph: {
    title: 'R1PP3R - Digital Liberation & Research',
    description: 'Esplorando i confini del digitale. Ricerca, analisi e comprensione dei sistemi.',
